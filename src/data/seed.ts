...
export const experimentSeeds: ExperimentSeed[] = [
  {
    ...
    heroImageUrl: "/images/experiments/density-layers-ten.png",
    gallery: [
  ...
  },
  {
    ...
    prep: "Cover the table; measure cornstarch into the bowl before the kid joins. Keep water nearby to add little by little.",
    safety:
      "Taste ban — not a snack (dry powder + paste). Watch mouthing for the 1yo. Wipe floor so it doesn’t get slippery when wet. Hands wash after. No heat, no other chemicals.",
    experience:
      "Mix Maïzena with water until it turns into a quirky fluid: pours like a liquid, but goes firm when you slap or squeeze it. Play — poke, scoop, drip — then rinse hands and wipe down.",
    kidCanDo: [
      "Touch, poke, scoop with a spoon or hands",
      "Help add water a splash at a time",
      "Squeeze a ball, then open the hand and watch it melt",
      "Compare slow pour vs hard poke",
    ],
    adultRole: [
      "Control water amount and keep paste out of mouths",
      "Narrate soft vs hard",
      "Let them lead mixing once the ratio is close",
      "Manage mess boundaries",
    ],
    steps: [
      { title: "Bowl of cornstarch", detail: "Put cornstarch in a wide bowl on a wipeable tray." },
      {
        title: "Add water slowly",
        detail: "Add water a little at a time; stir until thick but still drips (~2:1 cornstarch:water by feel).",
      },
      { title: "Slow vs poke", detail: "Slow pour flows; fast poke or squeeze feels firm." },
      { title: "Play", detail: "Scoop, slap, try a ball that melts when you stop squeezing." },
      {
        title: "Clean-up",
        detail: "Scrape into trash (avoid pouring lots down the drain); rinse bowl and hands.",
      },
    ],
    notice: [
      "Slow = runny; hard poke = stiff.",
      "Squeezed handful can feel like dough then melt.",
      "Too much water = mostly liquid; too little = powdery.",
    ],
    stretch:
